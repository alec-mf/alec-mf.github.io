...
(function (root, factory) {
	...
	function _onElementMouseMove(evt) {
		...
		if (tooltipElm) {
			tooltipTop = (tooltipTop - scrollY + tooltipElm.offsetHeight + 0 >= window.innerHeight ? (tooltipTop - tooltipElm.offsetHeight - 0) : tooltipTop);
			tooltipLeft = (tooltipLeft - scrollX + tooltipElm.offsetWidth + 0 >= window.innerWidth ? (tooltipLeft - tooltipElm.offsetWidth - 0) : tooltipLeft);
